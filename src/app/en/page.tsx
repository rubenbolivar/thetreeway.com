...
export default function HomePage() {
  // Maintenance mode - To disable change MAINTENANCE_MODE to 'false' in next.config.ts
  ...
  // Original website content - DO NOT DELETE
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="/es/" className="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors">
                Español
              </a>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              We turn ideas into <span className="text-green-600">working technologies</span>
            </h1>
            <p className="text-xl sm:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              We develop complete digital solutions that propel your business. 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We combine technical expertise with strategic vision to create solutions that truly make a difference
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            <div className="text-center p-8 bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Guaranteed Quality</h3>
              <p className="text-gray-600 leading-relaxed">
                We deliver clean, efficient and maintainable code with industry best practices
              </p>
            </div>
            ...
            <div className="text-center p-8 bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                Agile methodologies that allow us to deliver high-quality results in record time
              </p>
            </div>
            ...
            <div className="text-center p-8 bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Constant Innovation</h3>
              <p className="text-gray-600 leading-relaxed">
                Always at the forefront with the latest technologies and development trends
              </p>
            </div>
          </div>
      ...
      <section id="services" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Comprehensive technology solutions adapted to your business specific needs
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 mb-6">Modern and responsive web applications with React, Next.js and the latest technologies</p>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 mb-6">Native and hybrid applications for iOS and Android with exceptional experiences</p>
              <ul className="text-sm text-gray-600 space-y-2">
                <li>• React Native</li>
                <li>• Flutter</li>
                <li>• Native iOS</li>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 mb-6">Robust and scalable architectures that power your application from the server</p>
              <ul className="text-sm text-gray-600 space-y-2">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">UX/UI Consulting</h3>
              <p className="text-gray-600 mb-6">Intuitive and functional designs that enhance user experience</p>
              <ul className="text-sm text-gray-600 space-y-2">
      ...
      <section id="portfolio" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Every project is a success story. Get to know some of the solutions we have developed
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6">Complete e-commerce platform with inventory management, payments and analytics</p>
            ...
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6">Mobile application for medical appointment management with integrated telemedicine</p>
                <div className="flex flex-wrap gap-2 mb-6">
            ...
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-6">Real-time dashboard for business data analysis with interactive visualizations</p>
                <div className="flex flex-wrap gap-2 mb-6">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">hello@thetreeway.com</p>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-300 mb-6 max-w-md">
                We transform ideas into innovative digital solutions that drive your business growth.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li><a href="#" className="hover:text-green-400 transition-colors">Web Development</a></li>
                <li><a href="#" className="hover:text-green-400 transition-colors">Mobile Apps</a></li>
                <li><a href="#" className="hover:text-green-400 transition-colors">Backend & APIs</a></li>
                <li><a href="#" className="hover:text-green-400 transition-colors">UX/UI Consulting</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">
              &copy; 2024 TheTreeWay. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
